...
public class Config {
    ...
    public static final long BOSS_ENEMY_HEALTH = 1000;
    ...
    public static final long NORMAL_BULLET_DAMAGE = 5;

    public static final long MACHINE_GUN_BULLET_DAMAGE = 20;

    public static final long SNIPER_BULLET_DAMAGE = 120;
